...
function Cifrar() {
    ...
    const handleSubmit = async () => {
      ...
      const currentTimestamp = new Date().toISOString().slice(0, 16); // Get current timestamp in the format yyyy-MM-ddTHH:mm
      if (timestamp < currentTimestamp) {
          alert('The inserted timestamp must not be from the past.');
          return;
      }
      ...
      console.log("formData: ", email, file, timestamp, aes_mode, sha);
      ...
      try {
          ...
          console.log(response.data.token.filename);
      ...
      <>
        ...
        <Row style={{display: "flex", height: "86vh", alignItems: "center", }}>
          ...
          <Col sm="12" md="4" lg="4" style={{display: "flex", flexDirection: "column", justifyContent: "center", backgroundColor: "#00800095", height: "75%", borderRadius: "5%", color: "white"}}>
              ...
              <Row style={{display: "flex", justifyContent: "center"}}>
                  <Button variant="contained" onClick={handleSubmit} style={{width:"70%", margin: "15px", height: "50px", borderRadius: "10px", backgroundColor: "black"}}>ENCRYPT</Button>
              </Row>
